...
# ------------------------------------------------------------------------------
# multiple  subject four classifier
# ------------------------------------------------------------------------------
...
def EEG_1d(num=1):
    ...
    model = Con1D_concate(8, 8, 16, 0.01, 256)  # generating model

    callbacks_list = [
        keras.callbacks.ModelCheckpoint(
            filepath='D:\\modelSave\\4fenlei_callbacks_' + str(num) + '.h5',
    ...
    path = 'D:\\modelSave\\4fenlei_' + str(num) + '.h5'
    model.save(path)
...
# ========================================================================================================================================
# Load the best-saved model for multiple subject four classification. Load the beat model you can reproduce the results in the paper
# ========================================================================================================================================
def load_model_best(num=3):
    isFive = True  # Determine whether the classification label is binary or multiple
    path2 = r'C:\Users\Administrator\Desktop\论文\absolute_psd_downsampled.xlsx'  # absolute power spectrum file
    data2 = pd.read_excel(path2)
    if isFive:
    ...
    path = 'D:\\modelSave\\multiple_subject_four_level_classification.h5'
    # 'multiple_subject_four_level_classification.h5'  is the model we saved
